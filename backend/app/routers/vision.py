...
def build_record_prompt(roster: List[str], target_fields, roster_ids: Optional[List[str]] = None) -> str:
    ...
    if len(fields) >= 2:
        ...
        return (
            ...
            "This is a REAL classroom grade sheet. Every number you read has consequences — "
            "students' final grades depend on your accuracy. Read SLOWLY and VERIFY each digit twice.\n"
            "If you are unsure about a digit, say so with low confidence rather than guessing.\n"
            "One wrong digit can change a student's grade. Treat every single cell as critical.\n\n"
